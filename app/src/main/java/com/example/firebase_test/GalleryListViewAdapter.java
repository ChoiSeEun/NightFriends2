...
public class GalleryListViewAdapter extends BaseAdapter {
    public ArrayList<GalleryListViewItem> items = new ArrayList<GalleryListViewItem>();
    @Override
    public int getCount() {
        return items.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GalleryListViewItem item = items.get(position);
    ...
    public void addItem(Bitmap bitmap, String path, String road, String date){
        GalleryListViewItem item = new GalleryListViewItem();
