...
*/
            ...
            tMapData.findPathDataWithType(TMapData.TMapPathType.PEDESTRIAN_PATH, point1, point2, passList, 10,
                    new TMapData.FindPathDataListenerCallback() {
                        ...
                        public void onFindPathData(TMapPolyLine polyLine) {
                            Log.e("폴리라인 그리기","");
                            Bitmap start = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.start);
                            Bitmap end = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.end);
                            Bitmap pass = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.empty);

                            mapView.setTMapPathIcon(start, end, pass); //경유지 아이콘 없애기
    ...
    public ArrayList midPoint_array(double lat1,double lon1,double lat2,double lon2){
